...
<div class="wrapper">
  <h2>Add Medicine Image</h2>
  <div>   
  </div>
  
  <form action="medicineadd_db.jsp"  method="post" enctype="multipart/form-data">
  	<div class="input_field">
        <input type="email" placeholder="Username" name="email" value="<%=session.getAttribute("distributor")%>" readonly="" required="">
    </div>
    <div class="input_field">
        <input type="text" placeholder="MedCode" name="med_code" value="<%=session.getAttribute("Medcode")%>" readonly="" required="">
    </div>
    <div class="input_field">
    	<input type="file" name="med_image" accept="image/*"/>
    </div>
    <div class="btn">
        <input type="submit">
    </div>
