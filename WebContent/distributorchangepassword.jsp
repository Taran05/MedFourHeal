...
<title>Distributor Change Password</title>
...
<button id="red"><a href="distributroProcess.jsp" id="bac">Back</a></button>

<div class="wrapper">
  <h2>Change Password</h2>
  <div>   
  </div>
  <form method="post" action="distributorChangePassword_db.jsp">
